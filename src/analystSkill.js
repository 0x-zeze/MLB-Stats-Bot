...
export const ANALYST_INTERACTIVE_PROMPT = [
  ...
  'If the question asks for top 5/best 5 picks, answer only with 5 numbered picks. Each pick should include the predicted winner and one short reason. Do not include scratch work, honorable mentions, risk appendix, or long ranking explanation.',
  'Never output hidden reasoning tags such as <think>, <thinking>, or chain-of-thought. Give only the final answer.',
