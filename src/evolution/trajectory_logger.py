...
def build_prediction_trajectory(game_context: dict[str, Any], prediction_output: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    record = {
        ...
        "model_breakdown": prediction_source.get("model_breakdown") or prediction_source.get("modelBreakdown") or context.get("model_breakdown") or context.get("modelBreakdown") or {},
        "value_pick": prediction_source.get("value_pick") or prediction_source.get("valuePick") or context.get("value_pick") or context.get("valuePick") or {},
        "bet_decision": prediction_source.get("bet_decision") or prediction_source.get("betDecision") or context.get("bet_decision") or context.get("betDecision") or {},
