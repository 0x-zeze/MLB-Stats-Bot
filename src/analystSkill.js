...
export function buildAnalystSkillSummary() {
  return [
    ...
    '- Tier 1 paling penting: SP, confirmed lineup/player availability, offense, bullpen, park, market odds.',
    '- Tier 2 hanya adjustment: weather, splits, recent form, Pythagorean/Log5 prior.',
    '- Tier 3 hanya context: team record, previous series winner, umpire, public betting, news sentiment, H2H.',
  ...
  '- Market edge: jika odds/implied probability tersedia, bandingkan dengan probabilitas model.',
    '- Value pick: tim dengan value edge terbaik bisa berbeda dari tim dengan probabilitas menang terbesar.',
