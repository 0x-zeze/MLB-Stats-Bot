...
class PromotionGateTests(unittest.TestCase):
    ...
    def test_no_bet_protections_cannot_be_removed_automatically(self):
        result = run_promotion_gate({"candidate_id": "cand-unsafe", "rule": "Remove NO BET protections for moneyline."}, self.metrics(), self.metrics(roi=0.08, log_loss=0.58), persist=False)
